                ...
                <nav class="nav" style="    justify-content: center;">
                    ...
                    <ul class="main_nav list-unstyled mb-0" id="mobileNav">
                        ...
                        <li class="dropdown" onclick="submenuShow(2)">
                            <a class="mainNanLink" href="JavaScript:void(0)">Member &nbsp; <i class="fal fa-angle-down"></i></a>
                            <ul class="dropdownItem list-unstyled" id="2">
                                <li><a class="mainNanLink" href="{{ url('member') }}">Member</a></li>
                                <li><a class="mainNanLink" href="{{ url('register-gide') }}">Registration Guideline</a></li>
                    ...
                    <a href="{{ url('blood') }}" class="memberReBtn blood" style="background: white;color: #d02804;border: 4px solid red;" ><i  class="fas fa-tint fa-fw"></i>click for Blood</a>
