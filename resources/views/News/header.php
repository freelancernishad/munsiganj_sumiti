...
<head>
    ...
    <link rel='stylesheet' id='t4bnewsticker-css' href='assets/css/t4bnewsticker.css' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='style-css' href='assets/css/style1.css' type='text/css' media='all' />
    ...
    <script type='text/javascript' async src='assets/js/page.js' id='addtoany-core-js'></script>
    <script type='text/javascript' src='assets/js/jquery.min.js' id='jquery-core-js'></script>
    <script type='text/javascript' src='assets/js/jquery.liscroll.js' id='liscroll-js'></script>
    ...
    <div class="container full_website">
                            ...
                            <ul id="menu-menu" class="nav navbar-nav">
                                ...
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    ...
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-21"><a
                                        title="জাতীয়" href="">জাতীয়</a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    id="menu-item-22"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22"><a
                                        title="আন্তর্জাতিক" href="">আন্তর্জাতিক</a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    id="menu-item-24"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-24"><a
                                        title="রাজনীতি" href="">রাজনীতি</a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    id="menu-item-28"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-28 dropdown">
                                    <a title="সারাদেশ" href="#" data-toggle="dropdown" class="dropdown-toggle"
                                        aria-haspopup="true">সারাদেশ <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-29"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-29">
                                            <a title="মুন্সীগঞ্জ" href="">মুন্সীগঞ্জ</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-34"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-34">
                                            <a title="টঙ্গীবাড়ী" href="">টঙ্গীবাড়ী</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-35"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-35">
                                            <a title="লৌহজং" href="">লৌহজং</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-36"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-36">
                                            <a title="শ্রীনগর" href="">শ্রীনগর</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-37"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-37">
                                            <a title="সিরাজদিখান" href="">সিরাজদিখান</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-33"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-33">
                                            <a title="গজারিয়া" href="">গজারিয়া</a>
                                        </li>
                                    </ul>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    ...
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-25"><a
                                        title="অর্থনীতি" href="">অর্থনীতি</a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    id="menu-item-23"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-23"><a
                                        title="বিনোদন" href="">বিনোদন</a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    id="menu-item-26"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-26 dropdown">
                                    <a title="খেলাধুলা" href="#" data-toggle="dropdown" class="dropdown-toggle"
                                        aria-haspopup="true">খেলাধুলা <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-30"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-30">
                                            <a title="ক্রিকেট" href="">ক্রিকেট</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            ...
                                            <a title="ফুটবল" href="">ফুটবল</a>
                                        </li>
                                        <li itemscope="itemscope"
                                            itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-31"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-31">
                                            <a title="টেনিস" href="">টেনিস</a>
                                        </li>
                                    </ul>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
        ...
        <div class="ticker-news">
            ...
            <ul id="ticker" class="js-hidden">
                <li><a href="" title="মুন্সীগঞ্জের পঞ্চসারে গণটিকা কার্যক্রম">মুন্সীগঞ্জের পঞ্চসারে গণটিকা কার্যক্রম</a>
                </li>
                <li><a href="" title="বিক্রমপুর ঐক্য সংঘের উদ্যোগে মিনিবার ফুটবল টুর্নামেন্ট উদ্বোধন">বিক্রমপুর ঐক্য
                        সংঘের
                        উদ্যোগে মিনিবার ফুটবল টুর্নামেন্ট উদ্বোধন</a></li>
                <li><a href="" title="সিরাজদিখানে খতমে বুখারী ও দস্তারবন্দী মাহফিল">সিরাজদিখানে খতমে বুখারী ও
                        দস্তারবন্দী
                        মাহফিল</a></li>
                <li><a href="" title="আগুনে পুড়ে ক্ষতিগ্রস্ত পরিবারের পাশে দাড়ালেন সাবেক আওয়ামী লীগ নেতা কপাসের">আগুনে
                        পুড়ে
                        ক্ষতিগ্রস্ত পরিবারের পাশে দাড়ালেন সাবেক আওয়ামী লীগ নেতা কপাসের</a></li>
                <li><a href="" title="ডাকাতদের রাম রাজত্ব চলছে সিরাজদিখানে">ডাকাতদের রাম রাজত্ব চলছে সিরাজদিখানে</a>
                </li>
                <li><a href="" title="সিরাজদিখানে কৃষিজমি থেকে বালু উত্তোলন বন্ধ করলেন এসিল্যান্ড">সিরাজদিখানে কৃষিজমি
                        থেকে
                        বালু উত্তোলন বন্ধ করলেন এসিল্যান্ড</a></li>
                <li><a href="" title="নতুন গানে দুই সহোদর">নতুন গানে দুই সহোদর</a></li>
            </ul>
