        ...
        <section class="hero_area">
            <div class="row p-0">
                ...
                <div class="col-md-9">
                    ...
                    <div class="">
                        <h4 class="bg-primary text-white p-2 rounded-3">Membership Application</h4>
                        ...
                        @foreach ($rows as $row)
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left row" method='post'
                            ...
                            <input class="form-control mx-2" type="file" name="image" id="image"
                            value="{{ $row->image }}">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="mt-2">
                                        ...
                                        value="{{ $row->age }}" required class="form-control">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mt-2">
                                            ...
                                            value="{{ $row->dob }}" required class="form-control">
                                        </div>
                                        </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <input type="text" id="pesahgot_address" value="{{ $row->pesahgot_address }}" required class="form-control">
                                </div>
                                </div>
...
height: 19px;" onclick="sameAddress()" type="checkbox" id="same_Address"> <label
            for="same_Address">একই ঠিকানা হলে টিক দিন</label></h5>
</div>
{{-- col-md-6 start --}}
<div class="col-md-12">
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="p_vill" id="p_vill"
            value="{{ $row->p_vill }}">
                            ...
                            <button class="btn btn-primary w-25 mx-auto mt-3" type="submit">Submit</button>
                        </form>
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method='post'
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Spouse_name" id="Spouse_name"
                                                value="{{ $row->Spouse_name }}" required>
                                        </div>
                                    </div>
                                    {{-- col-md-6 start --}}
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Contact Number 2</label>
                                            <input type="text" class="form-control" name="phoneNumber2" id="phoneNumber2"
                                        ...
                                        <div class="form-group">
                                            <select name="Reference" id="Reference" class="form-control" required>
                                                ...
                                                @foreach ($member as $memberList)
                                                    <option value="{{ $memberList->memberId }}">Member Id:
                                                        {{ $memberList->memberId }} . Name: {{ $memberList->name }} .
                                                        Father Name: {{ $memberList->father_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
