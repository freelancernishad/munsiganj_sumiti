    ...
    <div class="container" style="    padding: 50px 0px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                <a class="" href="{{ url('register') }}"><img class="" src="{{ asset('assets/img/member.png.gif') }}"
                        alt=""></a>
            </div>
        </div>
    </div>
...
<style>
    .committeeTitle {width: 250px;margin: 0 auto;border-bottom: 1px solid black;position: relative;}
...
h4.committeeTitlea:before {content: '';
    ...
    height: 3px;
    background: #ffffff;
    z-index: 999;transform: rotate(-18deg);}
    img.cImage {
    border-radius: 50%;
    height: 150px;
    width: 150px;
...
.committeeDetail {border: 2px solid #d02804;padding: 25px 0px 6px 37px;border-left: 0;position: relative;}

.commTitle {position: absolute;top: -18px;left: 0px;background: #d02804;color: white;font-size: 19px;padding: 4px 19px;border-top-right-radius: 7px;border-bottom-right-radius: 7px;}
...
.commTitle:after {content: '';position: absolute;top: 0;left: -55px;width: 55px;height: 28px;background: #d02804;}
...
.commTitler:after {content: '';position: absolute;top: 0;right: -55px;width: 55px;height: 28px;background: #d02804;}
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="d-flex">
                            ...
                            <div class="committeeimager">
                                <img class="cImager" width="120px" src="{{ $committeeList->image }}" alt="" />
                            </div>
