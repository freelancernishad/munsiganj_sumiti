...
@section('content')
    ...
    <main>
        ...
        border-bottom-left-radius: 9px; */
                ...
                .bn-news {width: 74%;line-height: 2.7;font-size: 26px;height: 80px;border: 2px solid red;margin-top: 6px;border-left: 0;border-right: 0;overflow: hidden;}
                button.abtn {
                        ...
                        <script src="https://d30fl32nd2baj9.cloudfront.net/js/new/breaking-news-ticker.min.js"></script>
                                        ...
                                        <div class="breaking-news-ticker" id="newsTicker-249">
                                            ...
                                            <div class="rainbowGradient">
                                                <div
                                                    ...
                                                    <span class="d-flex align-items-center">&nbsp;Notice <i class="fas fa-bell fa-fw"
                                                            style="font-size:25px"></i></span></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="bn-controls">
                                                ...
                                                <button class="abtn"><span class="bn-prev"><i class="fas fa-caret-left fa-fw" style="font-size:25px"></i></span></button>
                                                <button class="abtn"><span class="bn-action"><i class="fal fa-bars fa-fw" style=""></i></span></button>
                                                <button class="abtn"><span class="bn-next"><i class="fas fa-caret-right fa-fw" style="font-size:25px"></i></span></button>
                        ...
                        <div class="rainbowGradient2">
                            <div
                                ...
                                <span class="d-flex align-items-center">&nbsp;
                                    ...
                                    <span id="togglemarquee" class="run"
                                        onClick="togglemarquee('togglemarquee')"><i class="fal fa-bars fa-fw"
                                            style=""></i></span>
