                        ...
                        <div class="d-flex">
                                ...
                                <thead class="table-dark">
                                    <tr>
                                        <td colspan="2" width="50%">
                                            <h4>ঐতিহাসিক ধর্মীয় স্থাপনা সমূহ</h4>
                                        </td>
                                            ...
                                            <td style="    font-size: 20px;" width="70%">
                                                ...
                                                <ul>
                                                    ...
                                                    @foreach ($relcat as $relcatLIst)
                                                        <li style="    display: block !important;"><a
                                                                href="{{ url('HistoricalPlace?i=' . $relcatLIst->id) }}">
                                                                {{ int_en_to_bn(str_pad($i, 2, '0', STR_PAD_LEFT)) }}.
                                                                {{ $relcatLIst->name }}</a></li>
                                                        <?php $i++; ?>
                                                    @endforeach
                            ...
                            <table class="table table-bordered mt-5">
                                <thead class="table-dark">
                                    <tr>
                                        <td colspan="2" width="50%">
                                            <h4>ঐতিহাসিক স্থাপনা ও স্থান সমূহ</h4>
                                        </td>
                                            ...
                                            <td style="    font-size: 20px;" width="70%">
                                                ...
                                                <ul>
                                                    ...
                                                    @foreach ($hiscat as $hiscatLIst)
                                                        <li style="    display: block !important;"><a
                                                                href="{{ url('HistoricalPlace?i=' . $hiscatLIst->id) }}">
                                                                {{ int_en_to_bn(str_pad($i, 2, '0', STR_PAD_LEFT)) }}.
                                                                {{ $hiscatLIst->name }}</a></li>
                                                        <?php $i++; ?>
                                                    @endforeach
