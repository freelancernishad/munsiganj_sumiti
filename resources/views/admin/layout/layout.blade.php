...
<body class="nav-md">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{ route('members.index') }}" class="site_title"><i class="fa fa-paw"></i>
                            <span>{{ @config('constats.site_name') }}</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{ route('brandslider.index') }}"><i class="fas fa-home"></i> Brand
                                        Slider </span></a></li>
                                <li><a href="{{ route('mainslider.index') }}"><i class="fas fa-home"></i> Main Slider
                                        </span></a></li>
                                ...
                                <li><a><i class="fas fa-home"></i> Members <span class="fas fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ url('/admin/members?status=active') }}">Active Members</a>
                                        </li>
                                        <li><a href="{{ url('/admin/members?status=pending') }}">Pending Members</a>
                                        </li>
                                        <li><a href="{{ url('/admin/members?status=unpaid') }}">Unpaid Members</a>
                                        </li>
                                ...
                                <li><a href="{{ route('RegistrationGuideline.index') }}"><i class="fas fa-home"></i>
                                        Registration Guideline </span></a></li>
                                <li><a href="{{ route('committee.index') }}"><i class="fas fa-home"></i> Committee
                                        </span></a></li>
                                <li><a href="{{ url('/admin/committee?d=ex') }}"><i class="fas fa-home"></i> EX.
                                        Committee </span></a></li>
                                <li><a href="{{ route('globalcommittee.index') }}"><i class="fas fa-home"></i> Global
                                        Committee </span></a></li>
                                <li><a href="{{ route('gallery_category.index') }}"><i class="fas fa-home"></i>
                                        Gallery Category </span></a></li>
                                <li><a href="{{ route('gallery.index') }}"><i class="fas fa-home"></i> Gallery
                                        </span></a></li>
                                <li><a href="{{ route('allinfo.index') }}"><i class="fas fa-home"></i> Info
                                        </span></a></li>
                                <li><a href="{{ route('category.index') }}"><i class="fas fa-home"></i> Category
                                        </span></a></li>
                                <li><a href="{{ route('blog.index') }}"><i class="fas fa-home"></i> Blogs </span></a>
                                </li>
                                <li><a href="{{ route('ad.index') }}"><i class="fas fa-home"></i> Ad </span></a>
                                </li>
                                <li><a href="{{ route('video.index') }}"><i class="fas fa-home"></i> Video Ad
                                        </span></a></li>
                                <li><a href="{{ route('notice.index') }}"><i class="fas fa-home"></i> Notice
                                        </span></a></li>
                                <li><a href="{{ route('HistoryCategory.index') }}"><i class="fas fa-home"></i>
                                        History Category </span></a></li>
                                <li><a href="{{ route('HistoryPlace.index') }}"><i class="fas fa-home"></i> History
                                        Place </span></a></li>
                                <li><a href="{{ route('ProminentPersons.index') }}"><i class="fas fa-home"></i>
                        ...
                        <ul class=" navbar-right">
                            ...
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="{{ asset('admin_asset/images/img.jpg') }}" alt="">
                                    {{ Auth::user()->name }}
                                </a>
    ...
    <script>
        ...
        $('#memberImage , #committeeImage , #galleryImage , #infoImage , #brandsliderImage , #mainsliderImage , #blogImage , #categoryImage')
            .on('change', function() {
