                                            ...
                                            <div class="form-group" id="addmore">
                                                ...
                                                @if ($books != null)
                                                    @foreach ($books as $book)
                                                        ...
                                                        <div class="inputgroup  d-flex align-items-center mt-3"
                                                            id="row{{ $i }}" style="width: 100% !important;">
                                                            <div class="form-group" style="width:100%">
                                                                <label> Upload Pdf </label>
                                                                <input class="form-control" name="pdf[]"
                                                            ...
                                                            <span class="btn btn-danger btn_remove mb-0"
                                                                id="{{ $i }}">Remove</span>
                                                        </div>
                                                        <span style="color:red"
                                                            id="error_message{{ $i }}"></span>
                                                        @php
                                                            $i++;
                                                        @endphp
                                                    @endforeach
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="short_description"
                                            id="short_description" value="{{ $row->short_description }}">
                                    </div>
