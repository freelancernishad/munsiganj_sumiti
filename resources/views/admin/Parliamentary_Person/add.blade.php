...
@foreach ($rows as $row)
         ...
         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method='post' action="{{ route('Parliamentary_Person.store')}}" enctype="multipart/form-data">
						@csrf
