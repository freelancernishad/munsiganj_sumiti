                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="globalcommittee" id="globalcommittee" cols="30" rows="3" class="form-control"
                                            style="resize:none">{{ $row->globalcommittee }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Member Facilities</label>
                                        <textarea name="member_facilities" id="member_facilities" cols="30" rows="3" class="form-control"
                                            style="resize:none">{{ $row->member_facilities }}</textarea>
                                    </div>
